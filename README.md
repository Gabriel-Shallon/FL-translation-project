...
- Ayndryl was a very important member from FL, and here you can find some of his own words about FL

./FL Related/Some Coords Related.kml
- At the time I found a list of coords apparently found around FL posts, so I went on google earth checking them and started schizophrenically marking anything that could be related lol
...
You may find text in portuguese in those files (I wasn't planning on posting them here, thats why they are in docx), but if you are down this rabbit hole, translanting text in a known language should be no problem.
